...
class OrpInitTests(unittest.TestCase):
    def test_init_json_bootstraps_git_and_governance_runtime(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(payload["project_context"]["hygiene_command"], "orp hygiene --json")
            ...
            self.assertTrue((root / "orp" / "hygiene-policy.json").exists())
            ...
            self.assertIn("orp/hygiene-policy.json", surface_paths)
            ...
            self.assertEqual(state["governance"]["hygiene_policy_path"], "orp/hygiene-policy.json")
