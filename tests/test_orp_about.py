...
class OrpAboutTests(unittest.TestCase):
    def test_about_json_reports_agent_discovery_surfaces(self) -> None:
        ...
        self.assertEqual(payload["artifacts"]["project_context_json"], "orp/project.json")
        self.assertEqual(payload["artifacts"]["hygiene_policy_json"], "orp/hygiene-policy.json")
        ...
        self.assertEqual(payload["schemas"]["research_run"], "spec/v1/research-run.schema.json")
        self.assertEqual(payload["schemas"]["project_context"], "spec/v1/project-context.schema.json")
        ...
        self.assertIn("agenda", ability_ids)
        self.assertIn("agents", ability_ids)
        self.assertIn("project", ability_ids)
        self.assertIn("hygiene", ability_ids)
        self.assertIn("connections", ability_ids)
        self.assertIn("opportunities", ability_ids)
        ...
        self.assertIn("research", ability_ids)
        ...
        self.assertIn("agenda_refresh", command_names)
        self.assertIn("agenda_refresh_status", command_names)
        self.assertIn("agenda_enable_refreshes", command_names)
        self.assertIn("agenda_disable_refreshes", command_names)
        self.assertIn("agenda_actions", command_names)
        self.assertIn("agenda_suggestions", command_names)
        self.assertIn("agenda_focus", command_names)
        self.assertIn("agenda_set_north_star", command_names)
        self.assertIn("agents_root_show", command_names)
        self.assertIn("agents_root_set", command_names)
        self.assertIn("agents_sync", command_names)
        self.assertIn("agents_audit", command_names)
        self.assertIn("project_refresh", command_names)
        self.assertIn("project_show", command_names)
        self.assertIn("hygiene", command_names)
        self.assertIn("workspace_hygiene", command_names)
        self.assertIn("connections_providers", command_names)
        self.assertIn("connections_list", command_names)
        self.assertIn("connections_show", command_names)
        self.assertIn("connections_add", command_names)
        self.assertIn("connections_update", command_names)
        self.assertIn("connections_remove", command_names)
        self.assertIn("connections_sync", command_names)
        self.assertIn("connections_pull", command_names)
        self.assertIn("opportunities_list", command_names)
        self.assertIn("opportunities_show", command_names)
        self.assertIn("opportunities_focus", command_names)
        self.assertIn("opportunities_create", command_names)
        self.assertIn("opportunities_add", command_names)
        self.assertIn("opportunities_update", command_names)
        self.assertIn("opportunities_remove", command_names)
        self.assertIn("opportunities_sync", command_names)
        self.assertIn("opportunities_pull", command_names)
        ...
        self.assertIn("secrets_keychain_add", command_names)
        ...
        self.assertIn("research_ask", command_names)
        self.assertIn("research_profile_list", command_names)
        self.assertIn("research_profile_show", command_names)
        self.assertIn("research_status", command_names)
        self.assertIn("research_show", command_names)
        ...
        self.assertIn("agenda_refresh", json_commands)
        self.assertIn("agenda_refresh_status", json_commands)
        self.assertIn("agenda_enable_refreshes", json_commands)
        self.assertIn("agenda_disable_refreshes", json_commands)
        self.assertIn("agenda_actions", json_commands)
        self.assertIn("agenda_suggestions", json_commands)
        self.assertIn("agenda_focus", json_commands)
        self.assertIn("agenda_set_north_star", json_commands)
        self.assertIn("agents_root_show", json_commands)
        self.assertIn("agents_root_set", json_commands)
        self.assertIn("agents_sync", json_commands)
        self.assertIn("agents_audit", json_commands)
        self.assertIn("project_refresh", json_commands)
        self.assertIn("project_show", json_commands)
        self.assertIn("hygiene", json_commands)
        self.assertIn("workspace_hygiene", json_commands)
        self.assertIn("connections_providers", json_commands)
        self.assertIn("connections_list", json_commands)
        self.assertIn("connections_show", json_commands)
        self.assertIn("connections_add", json_commands)
        self.assertIn("connections_update", json_commands)
        self.assertIn("connections_remove", json_commands)
        self.assertIn("connections_sync", json_commands)
        self.assertIn("connections_pull", json_commands)
        self.assertIn("opportunities_list", json_commands)
        self.assertIn("opportunities_show", json_commands)
        self.assertIn("opportunities_focus", json_commands)
        self.assertIn("opportunities_create", json_commands)
        self.assertIn("opportunities_add", json_commands)
        self.assertIn("opportunities_update", json_commands)
        self.assertIn("opportunities_remove", json_commands)
        self.assertIn("opportunities_sync", json_commands)
        self.assertIn("opportunities_pull", json_commands)
        ...
        self.assertIn("secrets_keychain_add", json_commands)
        ...
        self.assertIn("research_ask", json_commands)
        self.assertIn("research_status", json_commands)
        self.assertIn("research_show", json_commands)
    ...
    def test_home_json_reports_repo_runtime_and_pack_summary(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertIn("orp agenda refresh --json", commands)
            self.assertIn("orp agenda refresh-status --json", commands)
            self.assertIn("orp agenda enable-refreshes --json", commands)
            self.assertIn("orp agenda disable-refreshes --json", commands)
            self.assertIn("orp agenda actions", commands)
            self.assertIn("orp agenda suggestions", commands)
            self.assertIn("orp agenda focus", commands)
            self.assertIn('orp agenda set-north-star "Advance the ocular controller and ORP ecosystems"', commands)
            self.assertIn("orp agents root show", commands)
            self.assertIn("orp agents audit", commands)
            self.assertIn("orp agents root set /absolute/path/to/projects", commands)
            self.assertIn("orp project show --json", commands)
            self.assertIn("orp project refresh --json", commands)
            self.assertIn("orp hygiene --json", commands)
            self.assertIn("orp connections list", commands)
            self.assertIn("orp connections providers", commands)
            self.assertIn("orp auth login", commands)
            self.assertIn("orp opportunities list", commands)
            self.assertIn("orp opportunities focus main-opportunities --limit 5", commands)
            self.assertIn('orp opportunities create main-opportunities --label "Main Opportunities"', commands)
            self.assertIn('orp opportunities add main-opportunities --title "vision-prize" --kind contest --section ocular-longevity --priority high', commands)
            ...
            self.assertIn('orp research ask "What should we investigate?" --json', commands)
    ...
    def test_cli_without_args_shows_home_screen(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(proc.returncode, 0, msg=proc.stderr + "\n" + proc.stdout)
            self.assertIn(
                "Agent-first CLI for workspace ledgers, operating agendas, secrets, scheduling, governed execution, and research workflows.",
                proc.stdout,
            )
            self.assertIn("Daily Loop", proc.stdout)
            self.assertIn("Command Families", proc.stdout)
            self.assertIn("workspace", proc.stdout)
            self.assertIn("agenda", proc.stdout)
            ...
            self.assertIn("orp agenda refresh --json", proc.stdout)
            self.assertIn("orp agenda refresh-status --json", proc.stdout)
            self.assertIn("orp workspace tabs main", proc.stdout)
            self.assertIn("orp agents audit", proc.stdout)
